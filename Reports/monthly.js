function generateMonthlyReport() {
    ...
    document.getElementById("totalRevenueMonth").textContent = totalRevenue.toLocaleString('en-US') + " SAR";
    document.getElementById("totalSeatsMonth").textContent = totalSeats.toLocaleString('en-US');
    document.getElementById("totalBookingsMonth").textContent = totalConfirmed.toLocaleString('en-US');
    document.getElementById("totalTrainsMonth").textContent = trainIds.size.toLocaleString('en-US');
